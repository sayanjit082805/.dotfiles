...
awful.screen.connect_for_each_screen(function(s)
  ...
  local image = wibox.widget {
    ...
    forced_width = 380,
    image = gears.filesystem.get_configuration_dir() .. "/theme/wallpapers/decay/" .. beautiful.name .. ".jpg",
  }
  ...
  launcherdisplay:setup {
    {
      image,
      {
        ...
        bg = {
          ...
          from = { 0, 0 },
          to = { 0, 500 },
          stops = { { 0.2, beautiful.bg_color .. "cc" }, { 1, beautiful.bg_3 } }
        },
        widget = wibox.container.background,
      },
      {
  ...
  awesome.connect_signal("toggle::applauncher", function()
    open()
    ...
    elseif not launcherdisplay.visible then
      slide:set(1080 / 2 - launcherdisplay.height / 2)
