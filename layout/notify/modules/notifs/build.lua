...
-- clear button
-------------------------------------------------------------------
local notifs_clear = require("layout.notify.modules.notifs.clear_button")
...
-- empty box
-------------------------------------------------------------------
local notifs_empty = require("layout.notify.modules.notifs.notifs-empty")
--------------------------------------------------------------------


-- Create notif
--------------------------------------------------------------
local create_notif = require("layout.notify.modules.notifs.creator")
---------------------------------------------------------------


-- Notifs container
--------------------------------------------------------------------
local notifs_container = require("layout.notify.modules.notifs.container")
--------------------------------------------------------------------
