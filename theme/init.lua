...
-- base yellow color
theme.yellow_color                       = colors.yellow

--base purple color
theme.purple_color                       = colors.purple
...
theme.icon_mono                          = "JetBrainsMono Nerd Font Mono "
...
--awesome logo
theme.awesome_icon                       = "~/.config/awesome/images/desk/awesomewm.svg"
