...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.placement.bottom_right(dashboard_d, { honor_workarea = true, margins = beautiful.useless_gap * 2 })
    awesome.connect_signal("dashboard::visible", function()
        dashboard_d.visible = not dashboard_d.visible
    end)
end)
